...
def main():
    ...
    sell_parser.add_argument("--notify", action="store_true", default=False, help="发送通知")
    sell_parser.add_argument("--ntfy-topic", type=str, default=settings.NATY_TOPIC_BUY_SELL_NOTIFY, help="ntfy主题名称")
